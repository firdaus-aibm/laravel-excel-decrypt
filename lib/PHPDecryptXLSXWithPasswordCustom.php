...
ini_set('include_path', ini_get('include_path') . PATH_SEPARATOR . $libPath . PATH_SEPARATOR . $libPath . '/OLE');

require_once($libPath . '/OLE.php');
...
function decryptExcelFile($encryptedFilePath, $password, $decryptedFilePath)
{
	$oleObj = new OLE();
